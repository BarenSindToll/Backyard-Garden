...
export const PERMACULTURE_ELEMENT_TYPES = [
    ...
    'vegetable-garden', // catalogKey: vegetable_garden
    'staple-crops',     // catalogKey: staple_crops
...
export const CANONICAL_TYPE_COLORS = {
    ...
    vegetable_garden: '#5a9030', // vegetable garden green
    staple_crops:   '#a8821c',   // staple crops gold/amber
