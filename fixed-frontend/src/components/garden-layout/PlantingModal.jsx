            ...
            <div className="bg-white rounded-2xl shadow-2xl p-6 w-84 space-y-4 max-w-sm w-full mx-4">
                ...
                <div className="flex items-center gap-3">
                    ...
                    <div>
                        ...
                        <p className="text-xs text-gray-500">Set planting details</p>
                    </div>
                </div>

                {/* Planting date */}
                <div>
                    <label className="text-xs font-medium text-gray-600 block mb-1.5">Planting Date</label>
                    <input
                        type="date"
                        value={date}
                    ...
                    />
                    {suggestedDate && (
                        <p className="text-xs text-gray-400 mt-1">Suggested based on your zone</p>
                    )}
                </div>
